...
public class Test {
	...
	public static void main(String[] args) {
		 ...
		 Photo photo2 = new Photo("gigabyte.jpg",toTagsLinkedList("motherboard, hardware"));
		 Photo photo3 = new Photo("Msi.jpg",toTagsLinkedList("GPU"));
		 manager.addPhoto(photo1);
		 manager.addPhoto(photo2);
		 manager.addPhoto(photo3);
		 Album album1 = new Album("Parts", "hardware", manager);
		 Album album2 = new Album("gpus", "GPU", manager);
		 System.out.println(album1.getPhotos());
		 System.out.println(album2.getPhotos());
		 manager.deletePhoto("pcINroom.jpg");
		 System.out.println(album1.getPhotos());
		 System.out.println(album2.getPhotos());
